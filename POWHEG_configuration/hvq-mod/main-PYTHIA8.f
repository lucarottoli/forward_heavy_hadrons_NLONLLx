      ...
      integer py8tune
      logical nohad,noMPI,noQED,nogQQ,alt_recoil
      common/cpy8tune/py8tune,nohad,noMPI,noQED,nogQQ,alt_recoil
      real * 8 qmass
      common/cpyqmass/qmass


      qmass = powheginput("#qmass")
      if (qmass < 0) then
         write(*,*) "qmass must be set and positive! Exiting ... "
         call pwhg_exit(-1)
      endif
      ...
      nohad= powheginput("#nohad") == 1
      nogQQ = powheginput("#nogQQ") == 1
      noQED = powheginput("#noQED") == 1
      noMPI=powheginput("#noMPI") == 1
